        ...
        >
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-sm opacity-80 mt-1">Secure payment & fast processing</p>
            </div>
          ...
          <div className="bg-white rounded-xl p-6 text-gray-800 shadow-sm">
            ...
            <div className="flex items-center gap-4 mb-6">
              <div className={`flex items-center gap-3 ${step === 'amount' ? '' : 'opacity-60'}`}>
                <div className={`w-9 h-9 rounded-full flex items-center justify-center ${step === 'amount' ? 'bg-[#0A1A3A] text-white' : 'bg-gray-200 text-gray-600'}`}>1</div>
                <div>
              ...
              <div className={`flex items-center gap-3 ${step === 'methods' ? '' : 'opacity-60'}`}>
                <div className={`w-9 h-9 rounded-full flex items-center justify-center ${step === 'methods' ? 'bg-[#0A1A3A] text-white' : 'bg-gray-200 text-gray-600'}`}>2</div>
                <div>
                  <div className="text-sm font-semibold">Choose Method</div>
                  <div className="text-xs text-gray-500">Pick a payment provider</div>
                </div>
              </div>
            </div>
              ...
              <>
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="text-2xl font-semibold">{formatCurrency(finalAmount)}</div>
                  </div>
                ...
                <div className="mt-6 grid grid-cols-1 gap-4">
                  ...
                  >
                    {Icon(FaCreditCard, { className: 'opacity-90' })} Pay with Flutterwave
                  </button>
