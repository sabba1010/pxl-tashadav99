      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-gray-200 overflow-hidden mb-12">
          <div className="bg-gradient-to-r from-[#002a5c] to-[#00183b] px-6 py-8 sm:px-10 sm:py-12 text-white">
            ...
            <p className="text-xl sm:text-2xl font-semibold mt-2">Seller Upload Guide</p>
        ...
        <div className="space-y-10">
          ...
          <section className="bg-white rounded-2xl shadow-lg p-6 sm:p-8 border border-gray-200">
            ...
            <div className="bg-orange-50 border border-orange-200 rounded-xl p-4 sm:p-6 mb-6">
              <h3 className="text-lg sm:text-xl font-semibold text-orange-800 mb-4">Manual Listings (Very Important)</h3>
          ...
          <section className="bg-white rounded-2xl shadow-lg p-6 sm:p-8 border border-gray-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
              <div className="bg-gray-50 rounded-xl p-4 sm:p-5">
                ...
                <ul className="text-xs sm:text-sm space-y-2 text-gray-700">• Use number as username<br />• Random password<br />• Buyer contacts via chat for code</ul>
              </div>
              <div className="bg-gray-50 rounded-xl p-4 sm:p-5">
                <h4 className="font-semibold text-gray-900 mb-3">b. Social Media Boosting</h4>
                <ul className="text-xs sm:text-sm space-y-2 text-gray-700">• Needed details in username<br />• Random password<br />• No unnecessary info</ul>
              </div>
              <div className="bg-gray-50 rounded-xl p-4 sm:p-5">
                <h4 className="font-semibold text-gray-900 mb-3">c. eSIM Listings</h4>
                <ul className="text-xs sm:text-sm space-y-2 text-gray-700">• eSIM number in username<br />• Random password<br />• Must be valid & ready</ul>
              </div>
              <div className="bg-gray-50 rounded-xl p-4 sm:p-5">
                <h4 className="font-semibold text-gray-900 mb-3">d. Verification Services</h4>
                <ul className="text-xs sm:text-sm space-y-2 text-gray-700">• Only required details<br />• In username field<br />• Random password<br />• Manual Listing only</ul>
              </div>
              <div className="bg-gray-50 rounded-xl p-4 sm:p-5 md:col-span-2">
                <h4 className="font-semibold text-gray-900 mb-3">e. Website Listings</h4>
                <ul className="text-xs sm:text-sm space-y-2 text-gray-700">• Website name in username<br />• Random password<br />• Link in description/preview</ul>
              </div>
            </div>
          </section>
          ...
          <section className="bg-white rounded-2xl shadow-lg p-6 sm:p-8 border border-gray-200">
            ...
            <div className="bg-indigo-50 border border-indigo-200 rounded-xl p-4 sm:p-6">
              <p className="mb-4 text-gray-800 text-sm sm:text-base">Every description must:</p>
              <ul className="space-y-3 text-gray-700 text-sm sm:text-base">
          ...
          <section className="bg-white rounded-2xl shadow-lg p-6 sm:p-8 border border-gray-200">
            ...
            <div className="bg-red-50 border border-red-200 rounded-xl p-4 sm:p-6 text-red-900 text-sm sm:text-base">
          ...
          <section className="bg-white rounded-2xl shadow-lg p-6 sm:p-8 border border-gray-200">
            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-6">Special Listing Types</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
              <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-4 sm:p-6 border">
                <h3 className="text-lg sm:text-xl font-semibold mb-4 flex items-center gap-2">
                  <Image className="w-5 h-5 sm:w-6 sm:h-6" /> Working Picture Listings
                </h3>
              ...
              <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-xl p-4 sm:p-6 border">
                <h3 className="text-lg sm:text-xl font-semibold mb-4 flex items-center gap-2">
                  <FileText className="w-5 h-5 sm:w-6 sm:h-6" /> Document / Format Listings
                </h3>
                <ul className="text-sm sm:text-base space-y-2 text-gray-700">
                  <li>• Manual Listing only</li>
          ...
          <div className="bg-gradient-to-r from-[#002a5c] to-[#00183b] rounded-3xl shadow-2xl p-8 sm:p-12 text-white text-center">
            <h2 className="text-2xl sm:text-3xl font-bold mb-6">Final Reminder</h2>
