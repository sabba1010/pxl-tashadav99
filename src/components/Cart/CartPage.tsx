      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        {cartItems.length === 0 ? (
          <div className="bg-white rounded-[32px] p-20 text-center shadow-xl shadow-gray-100 border border-gray-50">
            ...
            <Link
              to="/"
              className="bg-[#0A1D37] text-white px-10 py-4 rounded-2xl font-bold hover:bg-[#D4A017] transition-all shadow-lg shadow-blue-100"
            >
              Explore Products
            </Link>
          </div>
              ...
              {cartItems.map((item) => (
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <h3 className="font-bold text-xl group-hover:text-[#D4A017] transition-colors">
                      {item.name}
                    </h3>
              ...
              <div className="bg-[#0A1D37] p-8 rounded-[32px] text-white shadow-2xl shadow-blue-900/20 sticky top-10">
                ...
                <div className="space-y-5 mb-10">
                  ...
                  <div className="pt-6 border-t border-white/10 flex justify-between items-center">
                    ...
                    <span className="text-4xl font-black text-[#D4A017]">
                      ${total.toFixed(2)}
                    </span>
                  </div>
                </div>
