...
const Marketplace: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F7F5F4] pb-10">
      ...
      <Link to="/seller-pay" className="fixed bottom-6 right-6 w-14 h-14 bg-[#33ac6f] text-white rounded-full shadow-lg flex items-center justify-center hover:bg-[#28965e] transition z-40"><PlusIcon size={24} /></Link>
    </div>
  );
};
