      ...
      >
        ...
        <div className="flex items-center gap-1 w-full justify-center">
          ...
          <button
            ...
            className={`px-2 py-1.5 text-sm font-semibold text-white rounded bg-gradient-to-r from-[#33ac6f] to-[#27b86a] hover:shadow-lg disabled:opacity-70 flex items-center gap-2 ${
