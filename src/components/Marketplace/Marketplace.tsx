...
const PurchaseIcon = BiSolidPurchaseTag as unknown as React.ComponentType<any>;
...
const gradientFromHex = (hex: string) => {
  ...
  return `linear-gradient(135deg, ${hex} 0%, #${hex2(r2)}${hex2(g2)}${hex2(
    b2
  )} 100%)`;
};
...
const ALL_ITEMS: Item[] = [
  {
    id: 101,
    title: "Instagram 10K Active",
    desc: "10K followers — high engagement, niche accounts available.",
    price: 12.0,
    seller: "InstaPro",
    delivery: "Instant",
    icon: FaInstagram,
  ...
  {
    id: 102,
    title: "Facebook Page Admin",
    desc: "Full admin access + BM when available.",
    price: 18.0,
    seller: "FBDeals",
    delivery: "Instant",
    icon: FaFacebookF,
  ...
  {
    id: 103,
    title: "TikTok 5K Followers",
    desc: "Organic-seeming followers + engagement service.",
    price: 9.0,
    seller: "TokBoost",
    delivery: "Instant",
    icon: SiTiktok,
  ...
  {
    id: 104,
    title: "YouTube Channel Starter",
    desc: "100 subscribers + basic branding",
    price: 15.0,
    seller: "StreamZone",
    delivery: "Instant",
    icon: FaYoutube,
  ...
  {
    id: 105,
    title: "Snapchat Account (aged)",
    desc: "Aged & active Snapchat account.",
    price: 6.0,
    seller: "SnapDeals",
    delivery: "Instant",
  ...
  {
    id: 106,
    title: "WhatsApp Business Number (US)",
    desc: "Number ready for WhatsApp + API set up guidance.",
    price: 7.5,
    seller: "AS Digitals",
    delivery: "5 mins",
    icon: FaWhatsapp,
  ...
  {
    id: 107,
    title: "Telegram Bulk Accounts",
    desc: "Multiple verified Telegram accounts",
    price: 4.0,
    seller: "TeleSellers",
    delivery: "Instant",
  ...
  {
    id: 108,
    title: "Discord Server + Mods",
    desc: "Active server with 1K members + moderation",
    price: 20.0,
    seller: "DiscordPro",
    delivery: "2 days",
    icon: FaDiscord,
  ...
  {
    id: 109,
    title: "Reddit Aged Account",
    desc: "Account with karma & history",
    price: 5.0,
    seller: "RedditWorks",
    delivery: "Instant",
    icon: FaRedditAlien,
  ...
  },
  {
    ...
    desc: "Business verified account",
    price: 6.5,
    seller: "PinPro",
    delivery: "Instant",
    icon: FaPinterest,
  ...
  {
    id: 111,
    title: "LinkedIn Premium Profile",
    desc: "Premium+ connections",
    price: 12.0,
    seller: "LinkPros",
    delivery: "Instant",
    icon: FaLinkedinIn,
  ...
  {
    id: 201,
    title: "Netflix Account (Family)",
    desc: "4-screen family plan, working",
    price: 8.0,
    seller: "StreamDeals",
    delivery: "Instant",
    icon: SiNetflix,
  ...
  {
    id: 202,
    title: "Amazon Giftcard $50",
    desc: "Redeemable in US store",
    price: 42.0,
    seller: "GiftCardsRUs",
    delivery: "Instant",
    icon: SiAmazon,
    category: "Giftcards & Misc",
    subcategory: "Amazon",
    platform: "amazon",
  },
  {
  ...
  {
    id: 301,
    title: "PayPal Verified (age)",
    desc: "Verified PayPal account with email",
    price: 25.0,
    seller: "PayPros",
    delivery: "Instant",
    icon: FaPaypal,
  ...
  {
    id: 402,
    title: "Shopify Store (starter)",
    desc: "Pre-built store + premium theme.",
    price: 35.0,
    seller: "ShopBuilders",
    delivery: "2 days",
    icon: FaShoppingCart,
  ...
  },
  {
    id: 403,
    title: "US eSIM (1 day)",
    desc: "Instant eSIM activation for US regions",
    price: 3.5,
    seller: "eSIMHub",
    delivery: "Instant",
    icon: MdSimCard,
    category: "eSIM & Mobile Services",
    subcategory: "eSIM (US)",
  },
  {
    id: 404,
    title: "Disposable Number (SMS)",
    desc: "Temporary number for SMS verification",
    price: 1.0,
    seller: "TempNums",
    delivery: "Instant",
    icon: MdPhoneIphone,
    category: "eSIM & Mobile Services",
    subcategory: "Disposable Numbers",
  },
  {
    id: 405,
    title: "VPN 1 Month",
    desc: "Fast VPN service, multiple locations",
    price: 4.0,
    seller: "SafeNet",
    delivery: "Instant",
    icon: MdVpnLock,
...
const renderSubIcon = (sub: string) => {
  ...
  const brandHex =
    ICON_COLOR_MAP.get(Icon as IconType) ||
    (() => {
      try {
  ...
  return (
    <div ref={ref}>
      <div className="flex items-center justify-between mb-3">
        <div className="text-sm font-semibold text-[#0A1A3A]">
          Account Category
        </div>
        <button onClick={clearAll} className="text-xs text-[#0A1A3A]">
          Clear
        </button>
      </div>
                ...
                <div className="px-3 pb-3 pt-1">
                  <div className="space-y-2 pr-2">
                    {categoryMap[main].map((sub) => {
                      const checked = (selectedSubcats[main] ?? []).includes(
                        sub
                      );
...
const Marketplace: React.FC = () => {
  ...
  useEffect(
    () => setCurrentPage(1),
    [searchQuery, selectedSubcats, priceRange, viewMode]
  );
  ...
  useEffect(() => {
    document.body.style.overflow =
      drawerOpen || !!selectedItem || mobileSearchOpen ? "hidden" : "";
  ...
  const renderIcon = (icon: Item["icon"], size = 36, realTime = false) => {
    ...
    const bg = brandHex
      ...
      : vibrantGradients[
          Math.abs(hashCode(String(icon))) % vibrantGradients.length
        ];
    ...
    return (
      <div
        style={{ position: "relative", width: badgeSize, height: badgeSize }}
      >
        {iconContent}
        {realTime && (
          <span
  ...
  const buyNow = async (item: Item | null) => {
    ...
    if (selectedItem && !protectionAccepted) {
      alert(
        "Please confirm you've checked the description and rating before purchase."
      );
      return;
    }
    ...
    <>
      {showBanner && (
        <div
          ...
          style={{ backgroundColor: "#33ac6f", color: "#fff" }}
        >
            ...
            <div className="hidden md:flex items-center gap-4">
              <div className="flex border rounded-lg overflow-hidden">
                <button
                  ...
                  className={`px-4 py-2 ${
                    viewMode === "list" ? "bg-[#0A1A3A] text-white" : "bg-white"
                  }`}
                >
                  List
                </button>
                <button
                  ...
                  className={`px-4 py-2 ${
                    viewMode === "grid" ? "bg-[#0A1A3A] text-white" : "bg-white"
                  }`}
                >
                  Grid
                </button>
                  ...
                  <div className="hidden sm:flex gap-2">
                    <button
                      ...
                      className={`px-3 py-1 rounded ${
                        viewMode === "list" ? "bg-[#0A1A3A] text-white" : ""
                      }`}
                    >
                      List
                    </button>
                    <button
                      onClick={() => setViewMode("grid")}
                      className={`px-3 py-1 rounded ${
                        viewMode === "grid" ? "bg-[#0A1A3A] text-white" : ""
                      }`}
                    >
                      Grid
                    </button>
        ...
        {selectedItem && (
          <>
            ...
            <div className="fixed inset-x-0 bottom-0 sm:inset-auto sm:top-1/2 sm:left-1/2 sm:-translate-x-1/2 sm:-translate-y-1/2 sm:max-w-lg sm:w-full bg-white rounded-t-3xl sm:rounded-3xl z-50 max-h-[90vh] sm:max-h-[80vh] overflow-y-auto shadow-2xl">
              ...
              <div className="p-6">
                <div className="flex justify-center">
                  {renderIcon(selectedItem.icon, 72, !!selectedItem.realTime)}
                </div>
                ...
                <div className="mt-6 text-left space-y-4 text-sm">
                  <div>
                    ...
                    <p className="text-gray-600">
                      {selectedItem.desc ||
                        "High-quality account with warranty."}
                    </p>
                  </div>
                  ...
                  <div className="border p-3 rounded-md bg-[#FBFFFB]">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <div className="text-xs text-gray-600">
                          Protected purchase — secure transaction & refund
                          policy
                        </div>
                      </div>
                    ...
                    <div className="mt-3">
                      <p className="text-xs text-gray-600">
                        Note: Check the buyer description & rating before
...
=======
                ...
                <div className="mt-4 flex items-center gap-3">
                  <input
                    id="protectionCheck"
                    type="checkbox"
                    checked={protectionAccepted}
                    onChange={(e) => setProtectionAccepted(e.target.checked)}
                    className="w-4 h-4"
                  />
                  <label
                    htmlFor="protectionCheck"
                    className="text-xs text-gray-700"
                  >
                    I have read the description and checked the seller rating
                  </label>
                </div>
                ...
                <div className="mt-6 grid grid-cols-1 gap-3">
                  <button
                    ...
                    disabled={
                      processingIds.includes(selectedItem.id) ||
                      !protectionAccepted
                    }
                  >
                    {processingIds.includes(selectedItem.id)
