        ...
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">All orders placed on your platform</p>
            </div>
              ...
              <div className="max-h-[62vh] overflow-y-auto pr-4">
                {filtered.length === 0 ? (
                  <div className="py-20 flex flex-col items-center text-center text-gray-500">
                    ...
                    <h3 className="text-xl font-semibold text-[#0A1A3A] mb-2">No Orders</h3>
                    <p className="text-gray-500 max-w-md">You haven't placed any orders yet. Explore the marketplace and grab great offers!</p>
                  ...
                  <div className="space-y-6">
                    {filtered.map((o) => (
                      <div key={o.id} className="bg-[#F8FAFB] rounded-lg p-6 flex items-start gap-6 border border-[rgba(0,0,0,0.03)] flex-wrap">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-start justify-between gap-6">
                            <div className="flex-1">
                              ...
                              <h3 className="text-base font-semibold text-[#0A1A3A] mt-3 truncate">{o.title}</h3>
                              <p className="text-sm text-gray-500 mt-2">{o.desc}</p>
                            ...
                            <div className="w-44 text-right flex flex-col items-end gap-3">
                              ...
                              <div className="text-xl font-bold text-[#0A1A3A]">${o.price}</div>

                              <div className="flex items-center gap-2 mt-2">
                                <button className="px-3 py-1 rounded-md bg-[#d4a643] text-white text-sm inline-flex items-center gap-2">
