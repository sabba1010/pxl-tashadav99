...
const RecoLogisticsTimeline: React.FC = () => {
  return (
    <div className="w-full bg-white py-20 overflow-x-hidden flex justify-center">
      {/* Responsive override for mobile speed */}
      <style>{`
...
export default RecoLogisticsTimeline;
