...
const WithdrawalRequests: React.FC = () => {
  ...
  const fetchWithdrawalsData = async (): Promise<WithdrawalRequest[]> => {
    const [wRes, pRes, rRes] = await Promise.all([
      fetch("http://72.244.153.24:3200/withdraw/getall"),
      fetch("http://72.244.153.24:3200/purchase/getall"),
      fetch("http://72.244.153.24:3200/purchase/report/getall")
    ]);
  ...
  const handleReview = async (req: WithdrawalRequest) => {
    ...
    try {
      const userRes = await fetch("http://72.244.153.24:3200/api/user/getall");
        ...
        <WithdrawalModal 
          ...
          onUpdateStatus={async (id, status, reason) => {
            ...
            try {
              ...
              const res = await fetch(`http://72.244.153.24:3200/withdraw/${endpoint}/${id}`, {
                method: "PUT",
