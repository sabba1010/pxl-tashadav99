...
//   useEffect(() => {
//     Promise.all([
//       fetch("https://tasha-vps-backend-2.onrender.com/product/all-sells").then((r) => r.json()),
//       fetch("https://tasha-vps-backend-2.onrender.com/api/user/getall").then((r) => r.json()),
//     ])
