...
const DashboardSeller: React.FC = () => {
    ...
    const fetchData = async () => {
      ...
      try {
        const [prodRes, purchaseRes, ratingsRes, referralRes] = await Promise.all([
          axios.get<any[]>("https://acctempire.com/api/product/all-sells"),
          axios.get<any[]>("https://acctempire.com/api/purchase/getall", { params: { email: user.email, role: 'seller' } }),
          axios.get<any>(`https://acctempire.com/api/rating/seller/${user.email}`),
          axios.get<any>("https://acctempire.com/api/referral/stats", { params: { email: user.email } }),
        ]);
  ...
  useEffect(() => {
    const fetchReports = async () => {
      try {
        const res = await axios.get("https://acctempire.com/api/purchase/report/getall");
