...
//           axios.get<any>(`https://vps-backend-server-beta.vercel.app/rating/seller/${user.email}`),
//           axios.get<any>("https://vps-backend-server-beta.vercel.app/referral/stats", { params: { email: user.email } }),
//         ]);
...
//       try {
//         const res = await axios.get("https://vps-backend-server-beta.vercel.app/purchase/report/getall");
